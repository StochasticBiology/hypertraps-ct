...
./posteriors.ce --posterior  ../VerifyData/test-cross-sa-posterior.txt  > ../VerifyData/t-simple-sa-a.tmp &
./posteriors.ce --posterior  ../VerifyData/test-cross-sgd-posterior.txt  > ../VerifyData/t-simple-sgd-a.tmp &
...
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-90-1-sa-posterior-1.txt > ../VerifyData/t-bigcross-hard-90-1-sa-a.tmp &
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-90-1-sgd-posterior-1.txt > ../VerifyData/t-bigcross-hard-90-1-sgd-a.tmp &
...
# cross-cube observations
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-ct-10-posterior.txt > ../VerifyData/t-bigcross-hard-ct-10-a.tmp &
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-ct-30-posterior.txt > ../VerifyData/t-bigcross-hard-ct-30-a.tmp &
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-ct-50-posterior.txt > ../VerifyData/t-bigcross-hard-ct-50-a.tmp &
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-ct-70-posterior.txt > ../VerifyData/t-bigcross-hard-ct-70-a.tmp &
./posteriors.ce --posterior ../VerifyData/test-bigcross-hard-ct-90-posterior.txt > ../VerifyData/t-bigcross-hard-ct-90-a.tmp &
