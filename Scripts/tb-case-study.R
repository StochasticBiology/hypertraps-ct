...
parallel.fn = function(fork, srcs, dests, times) {
  ...
  if(fork == 3) { return(HyperTraPS(dests, initialstates = srcs, samplegap = 10, penalty = 1, seed = 1, length = 4, kernel = 3))}
  if(fork == 4) { return(HyperTraPS(dests, initialstates = srcs, samplegap = 10, penalty = 1, seed = 2, length = 4, kernel = 3))}
...
n.fork = 10
expt.names = c("DT, seed 1", "DT, seed 2", "DT, penalty, seed 1", "DT, penalty, seed 2", 
               "CT, seed 1", "CT, seed 2", "CT, penalty, seed 1", "CT, penalty, seed 2",
               "CT pen mod 3 seed 1", "CT pen mod 3 seed 2")
