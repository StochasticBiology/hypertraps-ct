...
fname = c("test-xor-mod--1", "test-xor-mod-2", "test-xor-mod-3"); oneshot=FALSE; bigL=4
fname = c("test-cross-mod-1", "test-cross-mod-2", "test-cross-mod-3"); oneshot=FALSE; bigL=5
fname = c("test-ho-mod--1", "test-ho-mod-2", "test-ho-mod-3"); oneshot=FALSE; bigL=4
fname = c("test-ho-mod--1-l", "test-ho-mod-2-l", "test-ho-mod-3-l"); pneshot=FALSE; bigL=4
fname = c("test-ho-mod--1-sa", "test-ho-mod-2-sa", "test-ho-mod-3-sa"); oneshot=TRUE; bigL=4
fname = c("test-xor-mod--1-sa", "test-xor-mod-2-sa", "test-xor-mod-3-sa"); oneshot=TRUE; bigL=4
